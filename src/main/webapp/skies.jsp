...
<%-- 
   <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c"%> importation de la biblioteque jstl
--%>
<!DOCTYPE html>
<html>
    <head>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-8"><!-- right -->
                        <h2 style="text-align: center;">Ski</h2><br>
                        <!-- right 
                        <h5>Sort by(Price):</h5>
                        ...
                        <c:forEach items="${listProduit }" var="produit">
                            ...
                            <c:if test="${produit.value.getIdCategorie() ==2 }">
